...
export const CHARACTERS: Record<MainCode, Character> = {
  SNF: {
    ...
    traits: [
      "💳 미리 계획한 큰 소비에 과감하게 투자하는 편",
      "📊 예산은 짜지만 '보상 소비' 항목이 유독 큼",
      "💡 남들 눈에 보이는 소비에서 만족감을 느끼는 타입",
    ],
  ...
  SNL: {
    ...
    traits: [
      "💳 불필요한 지출을 철저히 배제하는 미니멀리스트",
      "📊 자동이체·적금·투자까지 시스템화 완료",
      "💡 노후 준비는 완벽하지만 '지금'을 즐기는 건 서툰 편",
    ],
  ...
  SRF: {
    ...
    traits: [
      "💳 같은 돈으로 남들보다 2배 더 누리는 스킬 보유",
      "📊 할인·적립·마일리지 조합의 달인",
      "💡 절약하면서도 삶의 질은 절대 타협 안 하는 주의",
    ],
  ...
  SRL: {
    ...
    traits: [
      "💳 충동구매 확률 0%. 장바구니에 3일 숙성 후 결제",
      "📊 가계부 앱 3개 동시 운용, 1원 단위까지 추적",
      "💡 돈 걱정은 없지만 가끔 '나를 위한 소비'가 필요한 타입",
    ],
  ...
  PNF: {
    ...
    traits: [
      "💳 생활비는 대충, 투자금은 과감하게 쓰는 스타일",
      "📊 수익률 +50%도 -30%도 경험한 롤러코스터 인생",
      "💡 감각은 좋지만 리스크 관리가 영원한 숙제",
    ],
  ...
  PNL: {
    ...
    traits: [
      "💳 일상 소비는 무관심, 재테크엔 레이저 집중",
      "📊 겉으론 자유로워 보이지만 통장 구조는 의외로 체계적",
      "💡 투자 수다는 좋아하지만 소비 계획은 귀찮아하는 편",
    ],
  ...
  PRF: {
    ...
    traits: [
      "💳 '지금 이 순간'이 최우선, 미래는 미래의 내가 알아서",
      "📊 통장 잔고 확인? 무서워서 안 봄",
      "💡 경험과 추억에 돈을 아끼지 않는 낭만파",
    ],
  ...
  PRL: {
    ...
    traits: [
      "💳 큰 소비도, 큰 투자도 안 하는 안전 제일주의",
      "📊 적금 하나면 충분하다는 심플한 재테크 철학",
      "💡 리스크는 싫지만 물가 상승이라는 보이지 않는 적이 있음",
    ],
