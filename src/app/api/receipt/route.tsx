      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div style={{ fontSize: 22, color: "rgba(42,42,46,0.5)" }}>
              소비 성향 명세서
            </div>
          </div>
          ...
          >
            ...
            <div style={{ fontSize: 43, fontWeight: 700, color: "#2a2a2e" }}>
              {character.name}
            </div>
            <div
              style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                >
                  ...
                  <span
                    style={{ width: 56, textAlign: "right", fontWeight: 700 }}
                  >
                    {value}
                  </span>
                </div>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {character.traits.map(({ label, value }) => (
                ...
                >
                  <span style={{ flexShrink: 0, color: "rgba(42,42,46,0.55)" }}>
                    {label}
                  </span>
                  <span
                    style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: 20, color: "rgba(42,42,46,0.4)" }}>
                    나
                  </span>
                </div>
                <span style={{ color: "rgba(42,42,46,0.25)", fontSize: 36 }}>
                  {"\u00D7"}
                </span>
                <div
                  style={{
          ...
          >
            ...
            >
              ...
              <span style={{ flexShrink: 0, fontWeight: 700 }}>미확인</span>
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <span style={{ flexShrink: 0, fontWeight: 700 }}>???원</span>
            </div>
            <div
              style={{
                display: "flex",
